...
def rnn_train():
    ...
    ax[0].plot(loss_list, label='Loss', color='red')
    ax[0].set_title('Loss')
    ax[0].set_xlabel('Epochs')
    ax[0].set_ylabel('Loss')
    ax[0].grid()
    ax[0].legend()
    ax[1].plot(train_acc_list, label='Train Accuracy', color='blue')
    ax[1].plot(test_acc_list, label='Test Accuracy', color='green')
    ...
    plt.show()
    print(f'Plot saved at {script_dir}/model/lstm_{hidden_dim}_{num_layers}_{batch_size}_{lr}.png')
